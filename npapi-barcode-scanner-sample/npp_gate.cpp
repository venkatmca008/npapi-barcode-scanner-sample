...
static CMyScannerPlugin* pMySensorPlugin = NULL;


char* NPP_GetMIMEDescription(void)
{
  return "application/x-itc-myscanner";
}
...
//	fprintf (stderr, "NPP New for %s\n", pluginType);
  ...
  if (strcmp(pluginType, "application/x-itc-myscanner") == 0)
  {
	  CMyScannerPlugin * pMySensorPlugin = new CMyScannerPlugin(instance);
...
//	fprintf (stderr, "NPP Destroy\n");
	...
	if(pPluginInfo != NULL) 
	{
		CMyScannerPlugin * pMySensorPlugin = (CMyScannerPlugin *)pPluginInfo->pPlugin;
...
NPError	NPP_GetValue(NPP instance, NPPVariable variable, void *value)
{
	...
	case NPPVpluginDescriptionString:
		*((char **)value) = "Sample NPAPI Plugin for use with HTML5";
		break;
	case NPPVpluginScriptableNPObject:
		if (pluginInfo->iPluginType == 0)
		{
			CMyScannerPlugin* pMySensorPlugin = (CMyScannerPlugin*)pluginInfo->pPlugin;
